            ...
            {(() => {
              ...
              return (
                <div className="space-y-6">
                  ...
                  {/* Example image for this defect type */}
                  <div className="flex justify-center">
                    <img
                      src={`/images/${key}_001.jpg`}
                      alt={`Example of ${info.fullName} defect`}
                      className="w-80 h-80 object-cover rounded-lg border-2 border-gray-300 bg-gray-200"
                      onError={(e) => {
                        ...
                        if (parent && !parent.querySelector('.img-fallback')) {
                          ...
                          fallback.className = 'img-fallback w-80 h-80 bg-gray-200 rounded-lg flex items-center justify-center border-2 border-gray-300';
                          fallback.innerHTML = `<div class="text-center text-gray-500"><p class="font-medium">${info.fullName}</p><p class="text-sm">Example Image</p></div>`;
